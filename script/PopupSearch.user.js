...
fixPos = function (sel, e) {
  ...
  $('#ShowUpBox')
    ...
    .css('left', offsetLeft - m_left + fix + 'px');
...
PopupInit = function () {
  ...
  $('html').append(
    `<span id=\"ShowUpBox\"> <span id=\"showUpBody\"> <span id=\"popupWrapper\"> ${EngineList} </span> <span id=\"transPanel\" /> </span> </span>`
  );
  $DivBox = $('#ShowUpBox');
  $DivBox.hide();
...
GetOpt = function (id) {
  ...
  return GM_getValue(
    id,
    (ref = popData.optionList.find(function (item) {
      return item.id === id;
    })) != null
      ? ref.defaultValue
      : void 0
